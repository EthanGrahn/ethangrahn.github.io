<template>
  <v-container>
    ...
    <v-card style="padding: 12px; margin-bottom: 25px">
      ...
      <v-card-text>
        <p>
          I am a Computer Scientist currently working with the <a href="https://www.usgs.gov/mission-areas/water-resources"  target="_blank" rel="noopener noreferrer">USGS
          Water Mission Area</a> as a DevOps Engineer and Application Developer.
    ...
    <v-card style="padding: 12px; margin-bottom: 25px">
      ...
      <v-divider style="margin: 4px"> </v-divider>
      <v-card-text>
          <h2 style="margin-bottom: 0.8em">Dakota State University</h2>
          <v-row>
          <v-col
          ...
          >
            <h4>Master's</h4>
            <a href="https://dsu.edu/programs/mscs/index.html"
              target="_blank"
          ...
          >
            <h4>Bachelor's</h4>
            <a href="https://dsu.edu/programs/computer-science-bs.html"
              target="_blank"
              rel="noopener noreferrer"
            >Computer Science</a>
            <a href="https://dsu.edu/programs/computer-game-design-bs.html"
              target="_blank"
              rel="noopener noreferrer"
          ...
          >
            <h4>Minor</h4>
            <a href="https://dsu.edu/programs/mathematics-applied-minor.html"
              target="_blank"
              rel="noopener noreferrer"
            >Applied Mathematics</a>
            <a href="https://dsu.edu/programs/computer-graphics-minor.html"
              target="_blank"
              rel="noopener noreferrer"
            >Computer Graphics</a>
          </v-col>
    ...
    <v-card style="padding: 12px; margin-bottom: 25px">
      ...
      <v-card-text>
          ...
          <ul>
            ...
            <li>Built microservices in AWS</li>
      ...
      <v-card-text>
          ...
          <ul>
            <li>Contributed to additive manufacturing software</li>
            <li>Implemented medial axis algorithm in C++</li>
            <li>Wrote and presented researched algorithm</li>
          </ul>
      </v-card-text>
        </v-col>
      </v-row>
    ...
    <v-card style="padding: 12px; margin-bottom: 25px">
      <v-card-title class="text-h3">Accomplishments</v-card-title>
      <v-divider style="margin: 4px"> </v-divider>
      <v-card-text>
          <h3>CyberCorps Scholar (Scholarship for Service)
    ...
    <v-row>
      <v-col>
    <v-card style="padding: 12px; margin-bottom: 25px">
      <v-card-title class="text-h3">Languages</v-card-title>
      <v-divider style="margin: 4px"></v-divider>
      <v-card-text>
        Java
        TypeScript
      ...
      <v-col>
    <v-card style="padding: 12px; margin-bottom: 25px">
      <v-card-title class="text-h3">Technologies</v-card-title>
      <v-divider style="margin: 4px"></v-divider>
      <v-card-text>
      </v-card-text>
    </v-card>
